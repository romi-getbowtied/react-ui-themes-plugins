...
function tw_get_apple_cards_carousel_items($items = null) {
...
function tw_render_apple_cards_carousel($items = null, $heading = 'Get to know your iSad.', $className = '') {
	$items = tw_get_apple_cards_carousel_items($items);
