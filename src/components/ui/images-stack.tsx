...
function CardRotate({ children, onSendToBack, sensitivity, disableDrag = false, dragElastic = 0.6 }: CardRotateProps) {
...
export default function Stack({
  ...
  const shouldDisableDrag = !dragEnabled || (mobileClickOnly && isMobile);
